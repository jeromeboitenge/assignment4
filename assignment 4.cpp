    ...
    public:
        ...
        void checkOut(Patron& patron, Book& book, string activity, string date) {
            ...
            if(patronIter == patrons.end() || bookIter == books.end()) {
                ...
                cout<<"your transactions is recorded"<<endl;
            }
        }
...
int main() {
	...
	int date;
	string genre;
		string isbn1,title1,author1;
	int date1;
	string genre1;
   
  
    cout<<"enter the details of the first book(ISBN,Title,Author, Copyright date,genre) \n";
    cin>>isbn>>title>>author>>date>>genre;
     Book book1(isbn, title, author, date, Genre::Fiction);
    cout<<"enter the details of the second book(ISBN,Title,Author, Copyright date,genre) \n";
     cin>>isbn1>>title1>>author1>>date1>>genre1;
      
Book book2(isbn1, title1, author1, date1, Genre::NonFiction);
string name;
string id;
int loan;
...
cin>>id;
cout<<"enter the loan of the patron\n";
    Patron person1(name,id,loan);
    Library tran;
